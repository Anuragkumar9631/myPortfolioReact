 ...
 <div className="contact__container container grid">
    ...
    <div className="contact__info">
      <div className="info__items">
        ...
        <div>
          ...
          <h4 className="info__description">singhanurag7204@gmail.com</h4>
        </div>
      </div>
      ...
      <div className="info__items">
        ...
        <div>
          ...
          <h4 className="info__description">+919631521221</h4>
        </div>
      </div>
    </div>
  ...
  <form  className="contact__form">
    <div className="form__input-group">
      ...
      <div className="form__input-div">
        <input type="" placeholder='Your Subject' className="form__control" />
      </div>
    </div>
